...
class Personalize_Login_Plugin
{
    ...
    public function __construct()
    {
        ...
        // FORCE LOGIN FROM ALL OTHER URLs
        add_action('template_redirect', array($this, 'redirect_to_force_login'));
    ...
    public function render_login_form($attributes, $content = null)
    {
        ...
        if (isset($_REQUEST['redirect_to'])) {
            $attributes['redirect'] = wp_validate_redirect(
                $_REQUEST['redirect_to'], $attributes['redirect']
            );
        }
    ...
    /**
     * A shortcode for rendering the new user PRE registration form.
     *
     * @param array     $attributes Shortcode attributes.
     ...
     * @return string   The shortcode output
     */
    public function render_register_pre_form($attributes, $content = null)
    {
        $default_attributes = array('show_title' => false);
        $attributes = shortcode_atts($default_attributes, $attributes);
        ...
        if (is_user_logged_in()) {
            ...
            if (isset($_REQUEST['pre-register-errors'])) {
                $error_codes = explode(',', $_REQUEST['pre-register-errors']);
    ...
    public function redirect_to_force_login()
    {
